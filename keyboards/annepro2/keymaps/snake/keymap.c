...
https://github.com/rgoulter/qmk_firmware/tree/rgbmatrix-snake/layouts/community/planck_mit/rgbmatrix-snake
*/
...
*/
 ...
 [_SNAKE] = LAYOUT_60_ansi( /* FN1 */
    XXXXXXX,  XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, HALF, XXXXXXX, XXXXXXX, HALF, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,  DIRUP,
    XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX,                   XXXXXXX, DIRLEFT, DIRDOWN, DIRRGHT
),
 [_QWERTY] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL,          KC_LGUI, KC_LALT,                   KC_SPC,             KC_RALT, LT(_LOWER, KC_LEFT), LT(_RAISE, KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  u Layer FN1
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_LOWER] = LAYOUT_60_ansi( /* FN1 */
    ...
    _______, _______, _______,                            _______,                   _______, _______, MO(_RAISE), _______
),
  /*
  * Layer FN2
  * ,-----------------------------------------------------------------------------------------.
 ...
 [_RAISE] = LAYOUT_60_ansi( /* FN2 */
    ...
    _______, _______,    _______,                                     _______,                   _______,       MO(_LOWER),       MO(_RAISE),       SNAKE
 ),

 [_ADJUST] = LAYOUT_60_ansi( /* FN2 */
    _______, KC_AP2_BT1, KC_AP2_BT2, KC_AP2_BT3, KC_AP2_BT4, _______, _______, _______, _______, KC_AP_RGB_MOD, KC_AP_RGB_TOG, KC_AP_RGB_VAD, KC_AP_RGB_VAI, _______,
    _______, _______,    KC_UP,      _______,    _______,    _______, _______, _______, _______, _______,       KC_PSCR,       KC_HOME,       KC_END,        _______,
    _______, KC_LEFT,    KC_DOWN,    KC_RGHT,    _______,    _______, _______, _______, _______, _______,       KC_PGUP,       KC_PGDN,       _______,
    _______,             _______,    _______,    _______,    _______, _______, _______, _______, _______,       KC_INS,        KC_DEL,        _______,
    _______, _______,    _______,                                     _______,                   _______,       MO(_LOWER),       MO(_RAISE),       _______
 ),
};
// clang-format on
